    ...
    return(
        ...
        <Row>
            ...
            <ElementBadges badges={itemTags}/>
                ...
                variant="success float-start me-3">{t('common.edit')}</Button>
                ...
                variant="danger float-start me-3">{t('common.delete')}</Button>
